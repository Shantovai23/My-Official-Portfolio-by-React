...
const Objective = () => {
    return (<>
        <section style={{ backgroundColor: "azure"}} className='pt-5'>
            <div className="container">
                <h2 className='professional text-center py-5'>Professional Objective</h2>
                <div className="row ">
                    <div className="col-sm mt-5  centerized">
                        <div className='centerized-text'>
                            <h1 className='intro-name'>Hi! I'm <span className='first-name-color'>Hasibul</span> Hasan</h1>
